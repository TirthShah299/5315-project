...
const conS = process.env.DB_CONNECTION_STRING;
db.initialize(conS)
    .then(() => {
...
app.post('/login', (req, res) => {
    ...
    if (username === 'tirth' && password === '1234') { // Example credentials, replace with actual logic
...
console.log("Tirth ",restaurantId)
    try {
